...
<body>
    ...
    <br> <h3 style="text-align: center;"> Aici gasiti Produsele pentru sarbatori: </h3> <br>
        <div class="cards">
        <?php include("dbconection.php");
        $result = mysqli_query($conn,"SELECT * FROM cakes WHERE category='Sezon'");
        if($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ?>
                    <div class="card"> <a href="#">  <!-- href catre pagina unde sa vad descrierea completa a produsului -->
                      ...
                      <div class="card-title">
                         <h2 style="color: #cc0099; font-style: oblique;"> <?php echo $row['name']; ?> </h2>
                          <h4> <?php echo $row['price']; ?> lei/kg </h4> <br>
